...
public final class MainActivity extends Activity {
    ...
    private static final String BUILD_MARKER="CONTROL8";
    ...
    private void diagnosticsPage(){
        ...
        rowButton("重新扫描网易云控制接口",()->{NeteaseControlLab.rescan(this);NeteaseAidlDexInspector.scanAsync(this);Toast.makeText(this,"正在重新扫描",Toast.LENGTH_SHORT).show();});
